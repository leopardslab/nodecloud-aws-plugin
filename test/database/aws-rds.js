...
describe('AWS RDS', () => {
  ...
  it('should delete DB security group', (done) => {
    nock('https://rds.us-west-2.amazonaws.com:443', { encodedQueryParams: true })
      .post('/', 'Action=DeleteDBSecurityGroup&DBSecurityGroupName=mysecuritygroup&Version=2014-10-31')
      .reply(200, '<DeleteDBSecurityGroupResponse xmlns="http://rds.amazonaws.com/doc/2014-10-31/">\n  <ResponseMetadata>\n    <RequestId>b953881d-747e-11e7-b6e2-d1e9ad527066</RequestId>\n  </ResponseMetadata>\n</DeleteDBSecurityGroupResponse>\n', ['x-amzn-RequestId',
    ...
    rds.deleteDBSecurityGroup(params).then((res) => {
      assert.equal(res.ResponseMetadata.RequestId, 'b953881d-747e-11e7-b6e2-d1e9ad527066');
      done();
    });
  });

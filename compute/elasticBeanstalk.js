class ElasticBeanstalk {
    ...
    constructor(aws, options) {
        ...
        this._elasticBeanstalk = new this._AWS.ElasticBeanstalk({ apiVersion: this._apiVersion });
    }
    ...
    applyManagedAction(params) {
        return new Promise((resolve, reject) => {
            this._elasticBeanstalk.applyEnvironmentManagedAction(params, (error, data) => {
                if (error) {
                    reject(error);
                } else {
                    resolve(data);
